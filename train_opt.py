...
model = YOLO("result3/train/weights/best.pt")  # This is your fine-tuned model

# Fine-tune the model further on the updated dataset
results = model.train(
    data="data.yaml",          # Dataset config
    epochs=150,                # Increase to allow longer training
    imgsz=640,                 # Input image size
    batch=16,                  # Adjust per GPU capacity
    ...
    project="result3",         # Use a new folder for this run
